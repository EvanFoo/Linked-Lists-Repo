...
class Double_sentinel_list_tester:public Tester< Double_sentinel_list<Type> > {
	...
	public:
		Double_sentinel_list_tester( Double_sentinel_list<Type> *obj = nullptr ):Tester< Double_sentinel_list<Type> >( obj ) {
			// empty
		}
 ...
 *   head            head            the head is not 'nullptr' and starts a Double_node_tester on that
 *                                   node until the 'exit' command is typed
 *   head0           head            the head is 'nullptr'
 *   tail            tail            the tail is not 'nullptr' and starts a Double_node_tester on that
 *                                   node until the 'exit' command is typed
